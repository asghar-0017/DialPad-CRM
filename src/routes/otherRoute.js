...
const otherRoute = (app) => {
    app.get('/get-others', adminAuth.authenticate, checkRole(['admin', 'agent']), otherController.getAllOthers);
    ...
    app.delete('/delete-other/:leadId', adminAuth.authenticate, checkRole(['admin', 'agent']), otherController.deleteOther);
